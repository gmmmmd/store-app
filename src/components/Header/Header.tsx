  ...
  return (
    <header className={`${styles.Container} Container`}>
      ...
      <div className={styles.Inner}>
        <Link to={'/cart'} className={styles.Inner__link}>
        ...
        <Link to={'/login'} className={styles.Inner__link}>
          <svg width="30" height="30" viewBox="0 0 30 30">
            <path
